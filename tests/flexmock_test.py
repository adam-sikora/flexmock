...
@contextmanager
def assert_raises(expected_exception: Type[BaseException], match: Union[RE_TYPE, str]):
    ...
    Args:
        ...
        match: String or pattern to match the error message against.
    """
    try:
        yield
...
class RegularClass:
    ...
    def test_flexmock_should_reraise_exception_in_spy(self):
        ...
        flexmock(instance).should_call("get_stuff").once()
    ...
    def test_flexmock_should_reraise_exception_in_spy_with_return_values(self):
        ...
        instance = RaisesException()
        flexmock(instance).should_call("get_stuff").and_return("foo").once()
